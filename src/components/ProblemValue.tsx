...
import { Clock, SearchX, EyeOff, BarChart3, AlertCircle, CheckCircle2, ArrowRight } from "lucide-react";
...
export const ProblemValue: React.FC = () => {
  ...
  return (
    <section className="py-20 lg:py-28 bg-white relative overflow-hidden" id="the-challenge">
      {/* Background grid */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="mt-5 text-sm sm:text-base text-slate-600 leading-relaxed space-y-2 max-w-2xl mx-auto">
            <p>
              Between daily project deliverables, back-to-back stakeholder meetings, and family life, active professionals rarely have the mental bandwidth to spend 2–3 hours browsing job portals every evening.
            </p>
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-5">
                    ...
                    <span className="text-[10px] font-bold px-2.5 py-1 rounded-full bg-slate-200/70 text-slate-700">
                      {card.badge}
                    </span>
                  </div>
                ...
                <div className="relative z-10 mt-6 pt-4 border-t border-slate-200/60 flex items-center gap-1.5 text-xs font-semibold text-[#10B981]">
        ...
        <div className="mt-12 max-w-3xl mx-auto text-center">
          <a
            href="#what-we-do"
            className="inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-[#3E4C9A] hover:text-[#4F67B8] transition-colors group"
          >
            <span>See how our team takes over these tasks on your behalf</span>
