...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden bg-[#0B132B] text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12 lg:mb-16">
          {/* Executive Badge */}
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-slate-900/80 border border-white/10 text-slate-200 text-xs sm:text-sm font-medium mb-6 shadow-xl backdrop-blur-md">
            ...
            <span className="text-slate-300">Built for Full-Time Working Professionals</span>
          </div>
          ...
          {/* Supporting Copy */}
          <p className="text-base sm:text-lg md:text-xl text-slate-300 leading-relaxed font-normal mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
            <a
              href="#contact"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-gradient-to-r from-[#3E4C9A] via-[#4F67B8] to-[#3E4C9A] hover:from-[#4859b3] hover:to-[#5571d4] text-white font-bold text-base px-8 py-3.5 rounded-xl shadow-xl shadow-[#3E4C9A]/35 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-2xl focus:outline-none focus-visible:ring-2 focus-visible:ring-[#34D399]"
              id="hero-primary-cta"
            >
            ...
            <a
              href="#how-it-works"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-slate-900/80 hover:bg-slate-800 text-slate-200 hover:text-white font-semibold text-base px-7 py-3.5 rounded-xl border border-white/10 transition-all duration-300 hover:-translate-y-0.5 backdrop-blur-sm"
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-y-2 gap-x-6 text-xs text-slate-400 font-medium">
            <span className="flex items-center gap-1.5 text-slate-300">
              ...
              No Primary Passwords Required
            </span>
            <span className="flex items-center gap-1.5 text-slate-300">
              <CheckCircle2 className="w-3.5 h-3.5 text-[#34D399]" />
              100% Candidate Controlled Criteria
            </span>
            <span className="flex items-center gap-1.5 text-slate-300">
              <Clock className="w-3.5 h-3.5 text-[#34D399]" />
              Save 15–20 Hours Every Week
            </span>
            <span className="flex items-center gap-1.5 text-slate-300">
              <ShieldCheck className="w-3.5 h-3.5 text-[#34D399]" />
              Transparent Weekly Friday Digest
            </span>
          </div>
        </div>

        {/* Social Proof Company Strip */}
        <div className="max-w-5xl mx-auto mb-14 pt-6 border-t border-white/[0.08] text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3">
            {targetCompanies.map((company) => (
              <span
                key={company}
                className="text-xs sm:text-sm font-semibold text-slate-300 bg-white/[0.04] px-3 py-1 rounded-lg border border-white/[0.06] hover:text-white hover:border-white/20 transition-colors"
              >
                {company}
              </span>
            ))}
        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative rounded-3xl bg-[#101A36]/80 border border-white/10 backdrop-blur-2xl p-6 sm:p-8 md:p-10 shadow-2xl shadow-black/60">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between pb-6 border-b border-white/[0.08] gap-4 mb-8">
              ...
              <div className="flex items-center gap-2 text-xs text-slate-300 bg-[#0B132B]/80 px-4 py-2 rounded-xl border border-white/10 w-fit">
                <Lock className="w-3.5 h-3.5 text-[#34D399]" />
              ...
              {workflowSteps.map((step, idx) => {
                ...
                return (
                  <button
                    ...
                    type="button"
                    className={`relative text-left p-4 rounded-2xl transition-all duration-300 focus:outline-none ${
                      isActive
            ...
            <div className="rounded-2xl bg-[#070B19]/90 border border-white/[0.08] p-5 sm:p-7">
